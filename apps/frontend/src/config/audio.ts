...
export const AUDIO_EVENT_POLICIES: Record<AudioEventName, AudioEventPolicy> = {
  ...
  'rat.alert': { category: 'rat-awareness', cooldownMs: 180, maximumVoices: 2 },
  'rat.telegraph': { category: 'rat-attacks', cooldownMs: 150, maximumVoices: 3 },
  'rat.attack': { category: 'rat-attacks', cooldownMs: 90, maximumVoices: 3 },
  'rat.damage': { category: 'rat-attacks', cooldownMs: 90, maximumVoices: 3 },
  'rat.defeat': { category: 'rat-attacks', cooldownMs: 130, maximumVoices: 2 },
