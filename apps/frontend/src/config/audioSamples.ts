...
export const AUDIO_EVENT_SAMPLE_ROUTES = {
  ...
  'rat.alert': { variants: ['rat-alert'], gain: 0.28 },
  'rat.telegraph': { variants: ['rat-telegraph'], gain: 0.34, playbackRate: 1.12 },
  'rat.attack': { variants: ['rat-telegraph'], gain: 0.3 },
  'rat.damage': { variants: ['rat-alert'], gain: 0.3, playbackRate: 0.9 },
  'rat.defeat': { variants: ['rat-defeat'], gain: 0.34 },
