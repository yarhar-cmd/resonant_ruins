...
export const AUDIO_EVENT_SAMPLE_ROUTES = {
  ...
  'rat.alert': { variants: ['rat-alert'], gain: 0.4 },
  'rat.telegraph': { variants: ['rat-telegraph'], gain: 0.48, playbackRate: 1.12 },
  'rat.attack': { variants: ['rat-telegraph'], gain: 0.44 },
  'rat.damage': { variants: ['rat-alert'], gain: 0.42, playbackRate: 0.9 },
  'rat.defeat': { variants: ['rat-defeat'], gain: 0.48 },
