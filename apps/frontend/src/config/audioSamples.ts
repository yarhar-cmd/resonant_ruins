...
export const AUDIO_SAMPLE_ASSETS = {
  ...
  'rat-alert': '/audio/rat-alert.ogg',
  'rat-defeat': '/audio/rat-defeat.ogg',
  'rat-telegraph': '/audio/rat-telegraph.ogg',
...
export const AUDIO_EVENT_SAMPLE_ROUTES = {
  ...
  'rat.alert': { variants: ['rat-alert'], gain: 0.18 },
  'rat.telegraph': { variants: ['rat-telegraph'], gain: 0.22, playbackRate: 1.04 },
  'rat.attack': { variants: ['rat-telegraph'], gain: 0.18, playbackRate: 0.96 },
  'rat.damage': { variants: ['rat-alert'], gain: 0.2, playbackRate: 0.88 },
  'rat.defeat': { variants: ['rat-defeat'], gain: 0.24 },
